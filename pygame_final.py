...
pygame.mixer.init()
pygame.mixer.music.load("assets/headlinesdrake.mp3")
...
class Block(pygame.sprite.Sprite):
    def __init__(self):
        ...
        # self.image_right =  pygame.Surface((width, height))
        # change the colour of self.image
        self.image =  pygame.image.load("assets/ring.png")
...
class Lebron(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image_right =  pygame.image.load("assets/Lebron james.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("assets/curry.png")
        self.image = pygame.transform.scale_by(self.image, 0.1)
        self.rect = self.image.get_rect()
...
def game():
    ...
    while not done:
        ...
        # ------ DRAWING TO SCREEN
        background = pygame.image.load("assets/ogcavs.jpg")
